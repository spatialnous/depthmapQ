 ...
 * Encapsulates reading/writing settings so we don't have to faff around with constructing QSettings
 * in 7 different location. The read/write methods on this class create a temporary QSettings
 * object, so if you want to read/write more than one setting in one go, use a transaction.
 */
