...
#include "SegmentTulipLeafChoiceDlg.hpp"

#include "mainwindow.hpp"

#include <QMessageBox>

CSegmentTulipLeafChoiceDlg::CSegmentTulipLeafChoiceDlg(MetaGraphDM *graph, QWidget *parent)
    : QDialog(parent) {
    setupUi(this);
    m_radius = tr("");
    m_tulip_bins = 0;
...
void CSegmentTulipLeafChoiceDlg::OnAnalysisTulip(bool value) {
...
void CSegmentTulipLeafChoiceDlg::OnWeighted(bool value) {
    if (value) {
        UpdateData(true);
...
void CSegmentTulipLeafChoiceDlg::OnOK() {
    UpdateData(true);
...
void CSegmentTulipLeafChoiceDlg::OnCancel() { reject(); }

void CSegmentTulipLeafChoiceDlg::UpdateData(bool value) {
    if (value) {
...
void CSegmentTulipLeafChoiceDlg::showEvent(QShowEvent *event) {
