    ...
    if (comm) {
        ...
        case CMSCommunicator::IMPORTMIF:
            ...
            case MINFO_MULTIPLE:
                ...
                // multiple shapes per object.\n Please note that these have been broken up, so
            ...
            case MINFO_HEADER:
                emit showWarningMessage(
                    tr("Warning"),
                    tr("There was a problem reading the header information in your MIF file."));
                break;
            case MINFO_TABLE:
                emit showWarningMessage(
                    tr("Warning"),
                    tr("There was a problem reading the table data in your MID file."));
                break;
            case MINFO_MIFPARSE:
                emit showWarningMessage(
                    tr("Warning"),
                    tr("There was a problem reading the shape data in your MIF file.\n\
        ...
        case CMSCommunicator::MAKEISOVISTSFROMFILE: {
            ...
            try {
                ...
                emit showWarningMessage(tr("Warning"),
                                        tr("The isovists test file could not be parsed. Error: %1")
